    ...
    tblCompany = $("#tblCompany").DataTable({
        ...
        "columns": [
            ...
            { "data": "lookupValueName", "name": "LookupValueName", "autoWidth": true },
            {
                ...
                "mRender": function (o) {
                    return '<div class="c-action-btn-group"><a data-ajax-complete="CompanyModel.onComplete" data-ajax="true" class="btn btn-icon btn-outline-primary" data-ajax-mode="replace" data-ajax-update="#divUpdateCompany" href="/Company/Update/' + o.lookupValueId + '"><i class="bx bxs-pencil"></i></a>' +
