    ...
    tblUnit = $("#tblUnit").DataTable({
        ...
        "columns": [
            ...
            { "data": "lookupValueName", "name": "LookupValueName", "autoWidth": true },
            {
                ...
                "mRender": function (o) {
                    return '<div class="c-action-btn-group"><a data-ajax-complete="UnitModel.onComplete" data-ajax="true" class="btn btn-icon btn-outline-primary" data-ajax-mode="replace" data-ajax-update="#divUpdateUnit" href="/Unit/Update/' + o.lookupValueId + '"><i class="bx bxs-pencil"></i></a>' +
