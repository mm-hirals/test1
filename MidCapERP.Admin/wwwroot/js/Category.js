    ...
    tblCategory = $("#tblCategory").DataTable({
        ...
        "columns": [
            ...
            { "data": "lookupValueName", "name": "LookupValueName", "autoWidth": true },
            {
                ...
                "mRender": function (o) {
                    return '<div class="c-action-btn-group"><a data-ajax-complete="CategoryModel.onComplete" data-ajax="true" class="btn btn-icon btn-outline-primary" data-ajax-mode="replace" data-ajax-update="#divUpdateCategory" href="/Category/Update/' + o.lookupValueId + '"><i class="bx bxs-pencil"></i></a>' +
