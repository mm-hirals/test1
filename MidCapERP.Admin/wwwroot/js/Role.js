    ...
    tblRole = $("#tblRole").DataTable({
        ...
        "columns": [
            { "data": "name", "name": "name", "autoWidth": true },
            {
                ...
                "mRender": function (o) {
                    return '<div class="c-action-btn-group justify-content-end"><a class="btn btn-icon btn-outline-primary" href="/Role/RolePermission/' + o.id + '"><i class="bx bxs-pencil"></i></a></div>';
                }
            }
        ]
    });
