...
namespace MidCapERP.BusinessLogic.Services.ActivityLog
{
    public class ActivityLogsService : IActivityLogsService
    {
        ...
        public async Task<ActivityLogs> PerformActivityLog(int subjectTypeId, string subjectId, string description, string action, CancellationToken cancellationToken)
        {
        ...
        private ActivityLogs MapActivityLogs(int subjectTypeId, string subjectId, string description, string action)
        {
