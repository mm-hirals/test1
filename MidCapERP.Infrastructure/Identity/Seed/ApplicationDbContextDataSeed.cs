...
namespace MidCapERP.Infrastructure.Identity.Seed
{
    public class ApplicationDbContextDataSeed
    {
        ...
        {
            var collection = new List<string>() { "Users", "Role", "Dashboard", "Lookup", "Status", "Contractor", "SubjectType", "LookupValues", "ContractorCategoryMapping", "Customer", "ErrorLogs", "Category", "Company", "Unit", "WoodType", "AccessoriesType", "RawMaterial", "Accessories","Wood"
                };
